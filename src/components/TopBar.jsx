    ...
    <div className="absolute top-0 left-0 right-0 h-8 bg-black/90 backdrop-blur-md text-white text-sm flex items-center justify-between px-4 z-50 border-b border-white/10">
      ...
      <div className="flex items-center space-x-1 relative">
        ...
        <div className="relative">
          ...
          {showPowerMenu && (
            <div className="absolute right-0 top-8 bg-gray-800 border border-gray-600 rounded-lg shadow-xl py-2 min-w-48 z-50 animate-slideIn">
              ...
              <button className="w-full px-4 py-2 text-left hover:bg-gray-700 transition-colors flex items-center space-x-2">
                <Settings className="w-4 h-4" />
                <span>Settings</span>
              </button>
